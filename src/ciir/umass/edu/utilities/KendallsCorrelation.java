 ...
 */
 ...
 /**
 * Shyam Saladi (saladi@caltech.edu), Sept 1, 2017
 * Modified from org.apache.commons.math3.stat.correlation.KendallsCorrelation
 * to return the corcodant pairs, disconcodant pairs, and the effective number
 * of pairs
 *
 * Got rid of other unneeded methods
 */
public class KendallsCorrelation {
    ...
    public static double[] correlation(final double[] xArray, final double[] yArray)
        ...
        double[] ret_vals = new double[2];
        ret_vals[0] = (double)concordantMinusDiscordant;
        ret_vals[1] = FastMath.sqrt(nonTiedPairsMultiplied);
